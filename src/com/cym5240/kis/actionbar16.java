...
import com.cym5240.url.websan16;
...
public class actionbar16 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.548216, 127.080837);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar16.this, websan16.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("서울어린이대공원")
						.snippet("서울특별시 광진구 능동로 216 어린이대공원"))
				.showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163099&page=9";
