...
import com.cym5240.url.websan9;
...
public class actionbar9 extends SherlockActivity {
	...
	ImageView link2;
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.519437, 126.939728);
    ...
    link2.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent2 = new Intent(actionbar9.this, websan9.class);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("아쿠아플라넷63").snippet("서울특별시 영등포구 63로 50 한화금융센터_63")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163206&page=8";
