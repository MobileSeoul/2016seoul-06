...
import com.cym5240.url.websan20;
...
public class actionbar20 extends SherlockActivity {
	...
	ImageView link2;
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.581674, 126.978948);
    ...
    link2.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent2 = new Intent(actionbar20.this, websan20.class);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("국립어린이민속박물관").snippet("서울특별시 종로구 삼청로 37 국립민속박물관")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163047&page=9";
