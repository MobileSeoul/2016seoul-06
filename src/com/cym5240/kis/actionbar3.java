...
import com.cym5240.url.websan3;
...
public class actionbar3 extends SherlockActivity {
	...
	ImageView link2;
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.571757, 127.015292);
    ...
    link2.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent2 = new Intent(actionbar3.this, websan3.class);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("테지움").snippet("서울특별시 종로구 지봉로 19")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163342&page=6";
