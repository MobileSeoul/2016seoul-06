...
import com.cym5240.url.websan23;
...
public class actionbar23 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.468999, 126.959251);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar23.this, websan23.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("서울과학전시관")
						.snippet("서울특별시 관악구 낙성대로 101 서울시과학전시관")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=162965&page=10";
