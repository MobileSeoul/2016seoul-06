...
import com.cym5240.url.websan;
import com.cym5240.url.websan5;
...
public class actionbar5 extends SherlockActivity {
	...
	ImageView link2;
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.530799, 126.928343);
    ...
    link2.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent2 = new Intent(actionbar5.this, websan5.class);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("여의도 물빛광장").snippet("서울특별시 영등포구 여의동로 330")).showInfoWindow();
    /*googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.snack_bar3)).position(new LatLng(34.719326, 126.813657)).title("홍교관-한식당").snippet("서울시 강진군 병영면 성남리 184"));
    googleMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.snack_bar3)).position(new LatLng(34.715961, 126.814780)).title("보명식당-식당").snippet("서울시 강진군 병영면 성남리 140-7"));*/
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163294&page=7";
