...
import com.cym5240.url.websan18;
...
public class actionbar18 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.512634, 127.058860);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar18.this, websan18.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("코엑스 아쿠아리움")
						.snippet("서울특별시 강남구 영동대로 513 코엑스몰 B1")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163097&page=9";
