...
public class actionbar extends SherlockActivity {
	...
	LatLng location = new LatLng(37.582584, 126.973138);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar.this, websan.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("청와대사랑채")
						.snippet("서울특별시 종로구 효자로13길 45")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163356&page=6";
