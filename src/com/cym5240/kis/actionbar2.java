...
import com.cym5240.url.websan2;
...
public class actionbar2 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.539226, 126.841743);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar2.this, websan2.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("충우곤충박물관")
						.snippet("서울특별시 강서구 강서로 139 농촌진흥원")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163346&page=6";
