...
import com.cym5240.url.websan8;
...
public class actionbar8 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.554472, 126.981164);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar8.this, websan8.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("지구촌 민속 박물관")
						.snippet("서울특별시 중구 소파로 46 서울특별시교육연구정보원")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163247&page=7";
