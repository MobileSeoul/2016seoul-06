...
import com.cym5240.url.websan10;
...
public class actionbar10 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.571725, 126.987267);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar10.this, websan10.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("다이나믹메이즈")
						.snippet("서울특별시 종로구 인사동길 12 대일빌딩 지하1층")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163189&page=8";
