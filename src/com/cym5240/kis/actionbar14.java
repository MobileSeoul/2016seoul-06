...
import com.cym5240.url.websan14;
...
public class actionbar14 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.566725, 127.009474);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar14.this, websan14.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("동대문디자인플라자")
						.snippet("서울특별시 중구 을지로 281")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163118&page=9";
