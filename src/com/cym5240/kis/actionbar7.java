...
import com.cym5240.url.websan7;
...
public class actionbar7 extends SherlockActivity {
	...
	ImageView link2;
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.550575, 127.077580);
    ...
    link2.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent2 = new Intent(actionbar7.this, websan7.class);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("상상나라").snippet("서울특별시 광진구 능동로 216")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163287&page=7";
