...
import com.cym5240.url.websan15;
...
public class actionbar15 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.558249, 126.987902);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar15.this, websan15.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("서울애니메이션센터")
						.snippet("서울특별시 중구 소파로 126 서울애니매이션센타")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163107&page=9";
