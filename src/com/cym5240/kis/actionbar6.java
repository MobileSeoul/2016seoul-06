...
import com.cym5240.url.websan6;
...
public class actionbar6 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.523868, 126.980481);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar6.this, websan6.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("국립중앙박물관")
						.snippet("용산구 서빙고로 137 국립중앙박물관")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163293&page=7";
