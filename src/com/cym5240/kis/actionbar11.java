...
import com.cym5240.url.websan11;
...
public class actionbar11 extends SherlockActivity {
	 ...
	 */
	ImageView link2;
	LatLng location = new LatLng(37.510738, 127.096789);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar11.this, websan11.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("키자니아")
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163163&page=8";
