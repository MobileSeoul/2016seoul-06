...
import com.cym5240.kis.photoview.PhotoViewAttacher;
import com.cym5240.kis.photoview.PhotoViewAttacher.OnMatrixChangedListener;
import com.cym5240.kis.photoview.PhotoViewAttacher.OnPhotoTapListener;

public class GalleryView extends SherlockActivity {

	// static final String PHOTO_TAP_TOAST_STRING =
	// "Photo Tap! X: %.2f %% Y:%.2f %%";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (path != null)
			mImageView.setImageBitmap(Global.UriToBitmapCompress(Uri
	...
	private Intent createShareIntent() {
		Bitmap bm = null;
		if (path != null)
			bm = Global.UriToBitmapCompress(Uri.fromFile(new File(path)));
		if (image_uri != null)
			bm = Global.UriToBitmapCompress(image_uri);
		String share_temp_path = Environment
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (edit_mode) {
			menu.add(0, 1, 0, getString(R.string.ok))
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 1:
			...
			if (image_uri != null)
				bm = Global.UriToBitmapCompress(image_uri);
			Global.SaveBitmapToFileCache(bm, getCacheDir().toString(),
					"/attach_image.jpg");
