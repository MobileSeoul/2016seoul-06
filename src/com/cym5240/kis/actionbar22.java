...
import com.cym5240.url.websan22;
...
public class actionbar22 extends SherlockActivity {
	...
	ImageView link2;
	 ...
	 GoogleMap  food1;
	    ...
	    LatLng location = new LatLng(37.537005, 127.011430);
    ...
    link2.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intent2 = new Intent(actionbar22.this, websan22.class);
     ...
     */
    googleMap.addMarker(new MarkerOptions().position(location).title("디뮤지엄").snippet("서울특별시 용산구 독서당로29길 5-6 Replace한남 F동")).showInfoWindow();
	...
	parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=162978&page=10";
