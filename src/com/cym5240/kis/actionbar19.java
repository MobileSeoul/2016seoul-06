...
import com.cym5240.url.websan19;
...
public class actionbar19 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.536935, 126.977070);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar19.this, websan19.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("전쟁기념관")
						.snippet("서울특별시 용산구 이태원로 29 전쟁기념관")).showInfoWindow();
		/*
