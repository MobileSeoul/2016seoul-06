...
import com.cym5240.url.websan12;
...
public class actionbar12 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.576691, 126.937834);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar12.this, websan12.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("서대문자연사박물관")
						.snippet("서울특별시 서대문구 연희로32길 51")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163157&page=8";
