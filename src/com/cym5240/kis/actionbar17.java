...
import com.cym5240.url.websan17;
...
public class actionbar17 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.512542, 127.102425);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar17.this, websan17.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("뽀로로파크")
						.snippet("서울특별시 송파구 올림픽로 240 롯데월드")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163089&page=9";
