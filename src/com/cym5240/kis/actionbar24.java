...
import com.cym5240.url.websan24;
...
public class actionbar24 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.576566, 126.974884);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar24.this, websan24.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("국립고궁박물관")
						.snippet("서울특별시 종로구 효자로 12 국립고궁박물관")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=162959&page=10";
