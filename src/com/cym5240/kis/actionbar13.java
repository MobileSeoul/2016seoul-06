...
import com.cym5240.url.websan13;
...
public class actionbar13 extends SherlockActivity {
	...
	LatLng location = new LatLng(37.573824, 126.978100);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    link2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent2 = new Intent(actionbar13.this, websan13.class);
		 ...
		 */
		googleMap.addMarker(
				new MarkerOptions().position(location).title("대한민국역사박물관")
						.snippet("서울특별시 종로구 세종대로 198")).showInfoWindow();
		/*
		...
		parsing_url = "http://www.androidside.com/bbs/board.php?bo_table=B49&wr_id=163144&page=8";
